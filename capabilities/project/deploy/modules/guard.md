...
> **AWKN server override:** Guard applies to Windows-side orchestration. Server deployment remains artifact-only and forbids every `.git` file/directory and Git working-tree command.
