...
const MIGRATIONS: Migration[] = [
  ...
  },
  {
    ...
    sql: `
      CREATE TABLE IF NOT EXISTS cron_work_items (
        id TEXT PRIMARY KEY,
      ...
      CREATE TABLE IF NOT EXISTS cron_dead_letters (
        id TEXT PRIMARY KEY,
  ...
  },
  {
    ...
    sql: `
      ...
      UPDATE runs SET trace_id = lower(hex(randomblob(16))) WHERE trace_id IS NULL;
